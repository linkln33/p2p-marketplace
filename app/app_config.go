...
import (
	_ "market/x/bazaar/module"
	bazaarmoduletypes "market/x/bazaar/types"
	_ "market/x/market/module"
...
var (
	moduleAccPerms = []*authmodulev1.ModuleAccountPermission{
		...
		{Account: bazaarmoduletypes.ModuleName, Permissions: []string{authtypes.Minter, authtypes.Burner, authtypes.Staking}},
...
// this line is used by starport scaffolding # stargate/app/initGenesis
			...
			{
				Name:   bazaarmoduletypes.ModuleName,
				Config: appconfig.WrapAny(&bazaarmoduletypes.Module{}),
			},
